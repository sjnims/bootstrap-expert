...
description: This skill should be used when the user asks about Bootstrap typography, "how do I style text in Bootstrap", "show me Bootstrap heading styles", "how to create responsive tables", "Bootstrap table not responsive", "how do I format code blocks", "Bootstrap images not responsive", "how to add figure captions", display headings, lead text, text alignment, text formatting, tables, table styling, responsive images, figures, code blocks, blockquotes, lists, abbreviations, horizontal rules, Reboot CSS reset, or needs help styling text, tables, images, and other content elements in Bootstrap.
---
